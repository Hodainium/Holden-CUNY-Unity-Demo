    ...
    public class PhysicsMover : MonoBehaviour
    {
        ...
        public void VelocityUpdate(float deltaTime)
        {
            ...
            if (deltaTime > 0f)
            {
                ...
                Quaternion rotationFromCurrentToGoal = TransientRotation * (Quaternion.Inverse(InitialSimulationRotation)); //The difference between initial and transient rotations
