...
namespace KinematicCharacterController.Examples
{
    public class Teleporter : MonoBehaviour
    {
        ...
        public UnityAction<HoldenExampleCharacterController> OnCharacterTeleport;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                HoldenExampleCharacterController cc = other.GetComponent<HoldenExampleCharacterController>();
                if (cc)
                {
